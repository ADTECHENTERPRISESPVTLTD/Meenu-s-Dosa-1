...
const LOCATIONS = [
    {
        ...
        openingHours: [
            ...['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map((day) => ({ day, open: '08:00', close: '22:30', isClosed: false })),
        ],
...
async function seedLocations() {
    await location_1.Location.deleteOne({ name: "Meenu's Dosa - Main Outlet" });
