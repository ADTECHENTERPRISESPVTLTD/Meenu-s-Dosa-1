          ...
          {locations.map((l) => (
            <article key={l.id} className="flex flex-col rounded-3xl border bg-card p-6 sm:p-8">
              ...
              <div className="mt-5 flex flex-col gap-3 text-sm text-muted-foreground">
                ...
                <span className="flex gap-3"><svg className="text-primary" size={18} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>{l.hours}</span>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {l.mapsUrl && (
                  <a href={l.mapsUrl} target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-bold">
                    <svg size={14} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg> Google Maps
                  </a>
                )}
                {l.zomatoUrl && (
                  <a href={l.zomatoUrl} target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-2 rounded-full bg-red-500 px-4 py-2 text-sm font-bold text-white">
                    <svg size={14} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a2 2 0 00-2-2H5a2 2 0 00-2 2v18a2 2 0 002 2h14a2 2 0 002-2v-4" /></svg> Zomato
                  </a>
                )}
                {l.swiggyUrl && (
                  <a href={l.swiggyUrl} target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-2 rounded-full bg-orange-500 px-4 py-2 text-sm font-bold text-white">
                    <svg size={14} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a2 2 0 00-2-2H5a2 2 0 00-2 2v18a2 2 0 002 2h14a2 2 0 002-2v-4" /></svg> Swiggy
                  </a>
                )}
              </div>
            </article>
