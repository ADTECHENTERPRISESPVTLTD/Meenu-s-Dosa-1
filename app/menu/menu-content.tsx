  ...
  return <Shell>
    <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:py-20">
      ...
      <div className="mt-12 flex flex-col gap-16">
        {menuCategories.filter((c) => category === 'all' || c.id === category || c.slug === category).map(c => {
          const items = filtered.filter(item => item.category === c.id || item.category === c.slug || item.category === c.name)
